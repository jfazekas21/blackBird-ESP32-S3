...
/*********************************************************************
*
*       Defines related to BigFAT implementation
*/
#ifndef   BIGFAT_MAX_FILE_SIZE
  #define BIGFAT_MAX_FILE_SIZE            (0xFFFFFFFFuL - ((128uL * 1024uL) - 1uL))     // Maximum size of a fragment file. Configurable for testing purposes only.
#endif
#define BIGFAT_EXT_TEXT                   ".BigFAT"               // Extension for the fragment files.
#define BIGFAT_EXT_TEXT_LEN               7u                      // strlen(BIGFAT_EXT_TEXT) This value has to be kept in sync with BIGFAT_EXT_TEXT.
#define BIGFAT_EXT_MIN_INDEX              1u                      // Maximum value of the index in the extension of a fragment file.
#define BIGFAT_EXT_MAX_INDEX              999u                    // Maximum value of the index in the extension of a fragment file.
#define BIGFAT_EXT_NUM_DIGITS             3u                      // This value has to be kept in sync with BIGFAT_EXT_MAX_INDEX
#define BIGFAT_EXT_NUM_BYTES              (1u + BIGFAT_EXT_NUM_DIGITS + BIGFAT_EXT_TEXT_LEN)  // Total number of bytes in the extension. +1 for the extension separator.
#define BIGFAT_MAX_VOUME_NAME             16u                     // Maximum number of bytes in the name of the volume.
#define BIGFAT_SIZE_INVALID               0xFFFFFFFFFFFFFFFFuLL   // Value to indicate that the size of the file is not known and it has to be calculated.
...
typedef struct {
  ...
  U16                   ldBytesPerSector;           // Number of bytes in a logical sector as a power of 2 exponent. Typical values are: 9, 10, 11, 12.
  ...
  U16                   ldBytesPerCluster;          // Number of bytes in a cluster as a power of 2 exponent.
