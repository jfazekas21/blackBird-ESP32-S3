...
File    : FS_ConfigNOR_BM_SPIFI_nRF52840_NordicSemi_nRF52840_DK.c
Purpose : Configuration file for quad SPI NOR flashes.
*/

#include "FS.h"
#include "FS_NOR_HW_SPIFI_nRF52840_NordicSemi_nRF52840_DK.h"
...
void FS_X_AddDevices(void) {
  ...
  FS_NOR_SPIFI_SetHWType(0, &FS_NOR_HW_SPIFI_nRF52840_NordicSemi_nRF52840_DK);
