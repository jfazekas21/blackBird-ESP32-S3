...
File    : FS_ConfigNOR_BM_SFDP_STM32F407_ST_STM32F4DISCOVERY.c
...
*/
#include "FS.h"
#include "FS_NOR_HW_SPI_STM32F407_ST_STM32F4DISCOVERY.h"
...
void FS_X_AddDevices(void) {
  ...
  //
  FS_NOR_SFDP_SetHWType(0, &FS_NOR_HW_SPI_STM32F407_ST_STM32F4DISCOVERY);
  FS_NOR_SFDP_SetDeviceList(0, &FS_NOR_SPI_DeviceListSpansion);
}
