...
File    : FS_ConfigNOR_BM_SPIFI_STM32F769_ST_STM32F769I_EVAL.c
...
*/
#include "FS.h"
#include "FS_NOR_HW_SPIFI_STM32F769_ST_STM32F769I_EVAL.h"
...
*/
...
#ifndef   NOT_BASE_ADDR
  #define NOT_BASE_ADDR       0x90000000    // Base address of the NOR flash device to be used as storage.
#endif
  ...
  #define LOG_SECTOR_SIZE     512           // Logical sector size in bytes.
#endif
...
void FS_X_AddDevices(void) {
  ...
  FS_NOR_BM_Configure(0, NOT_BASE_ADDR, NOR_START_ADDR, NOR_SIZE);
  FS_NOR_BM_SetSectorSize(0, LOG_SECTOR_SIZE);
  //
  // Configure the NOR physical layer.
  //
  FS_NOR_SPIFI_SetHWType(0, &FS_NOR_HW_SPIFI_STM32F769_ST_STM32F769I_EVAL);
  FS_NOR_SPIFI_SetDeviceList(0, &FS_NOR_SPI_DeviceListMicron);
