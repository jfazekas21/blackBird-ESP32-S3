...
File    : FS_ConfigNOR_BM_SFDP_STM32H743_SEGGER_QSPI_Flash_Evaluator.c
Purpose : Configuration file for SPI NOR flashes with SFDP support.
*/
...
*/
#include "FS.h"
#include "FS_NOR_HW_SPI_STM32H743_SEGGER_QSPI_Flash_Evaluator.h"
...
void FS_X_AddDevices(void) {
  ...
  FS_NOR_SFDP_SetHWType(0, &FS_NOR_HW_SPI_STM32H743_SEGGER_QSPI_Flash_Evaluator);
