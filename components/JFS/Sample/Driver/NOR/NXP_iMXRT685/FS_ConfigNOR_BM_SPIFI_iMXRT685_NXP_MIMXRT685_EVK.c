...
File    : FS_ConfigNOR_BM_SPIFI_iMXRT685_NXP_MIMXRT685_EVK.c
...
*/
#include "FS.h"
#include "FS_NOR_HW_SPIFI_iMXRT685_NXP_MIMXRT685_EVK.h"
...
*/
#ifndef   ALLOC_SIZE
  #define ALLOC_SIZE          0x1000          // Size of memory dedicated to the file system. This value should be fine tuned according for your system.
#endif

#ifndef   NOR_BASE_ADDR
  #define NOR_BASE_ADDR       0x08000000      // Base address of the NOR flash device to be used as storage.
#endif

#ifndef   NOR_START_ADDR
  #define NOR_START_ADDR      0x08010000      // Start address of the first sector be used as storage. If the entire chip is used for file system, it is identical to the base address.
                                              // Note that we purposely do not use the first 64KB of the NOR flash device as storage to prevent overwriting the boot header.
#endif
...
void FS_X_AddDevices(void) {
  ...
  //
  FS_NOR_SPIFI_SetHWType(0, &FS_NOR_HW_SPIFI_iMXRT685_NXP_MIMXRT685_EVK);
