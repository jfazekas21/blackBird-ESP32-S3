...
File    : FS_ConfigNOR_BM_SPIFI_STM32H745_ST_STM32H745I_DISCO.c
...
*/
#include "FS.h"
#include "FS_NOR_HW_SPIFI_STM32H745_ST_STM32H745I_DISCO.h"
...
#ifndef   NOR_SIZE
  #define NOR_SIZE            0x08000000    // Number of bytes to be used for storage.
#endif
...
void FS_X_AddDevices(void) {
  ...
  //
  FS_NOR_SPIFI_SetHWType(0, &FS_NOR_HW_SPIFI_STM32H745_ST_STM32H745_DISCO);
  FS_NOR_SPIFI_SetDeviceList(0, &FS_NOR_SPI_DeviceListMicron_x);
