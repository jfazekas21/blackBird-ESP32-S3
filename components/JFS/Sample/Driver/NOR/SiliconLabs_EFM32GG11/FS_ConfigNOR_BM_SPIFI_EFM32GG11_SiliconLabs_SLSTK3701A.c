...
File    : FS_ConfigNOR_BM_SPIFI_EFM32GG11_SiliconLabs_SLSTK3701A.c
Purpose : FS configuration functions for the block map NOR driver and quad SPI NOR flash.
*/
...
**********************************************************************
*/
#define ALLOC_SIZE            0x3000              // Size defined in bytes
...
void FS_X_AddDevices(void) {
  ...
  FS_NOR_BM_SetEraseVerification(0, 1);
