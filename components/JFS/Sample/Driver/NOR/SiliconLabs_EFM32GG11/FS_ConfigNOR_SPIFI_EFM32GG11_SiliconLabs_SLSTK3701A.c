...
File    : FS_ConfigNOR_SPIFI_EFM32GG11_SiliconLabs_SLSTK3701A.c
Purpose : FS configuration functions for the NOR driver and quad SPI NOR flash.
*/
...
*/
#include "FS.h"
#include "FS_NOR_HW_SPIFI_EFM32GG11_SiliconLabs_SLSTK3701A.h"
...
**********************************************************************
*/
#define ALLOC_SIZE            0xA000              // Size defined in bytes
#define FLASH_BASE_ADDR       0xC0000000
#define FLASH_START_ADDR      0xC0000000
...
void FS_X_AddDevices(void) {
  ...
  FS_NOR_SetEraseVerification(0, 1);
#endif // FS_NOR_VERIFY_ERASE
#if FS_NOR_VERIFY_WRITE
  FS_NOR_SetWriteVerification(0, 1);
  ...
  FS_NOR_SPIFI_SetHWType(0, &FS_NOR_HW_SPIFI_EFM32GG11_SiliconLabs_SLSTK3701A);
