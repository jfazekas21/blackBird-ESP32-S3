...
File    : FS_ConfigNOR_SFDP_LPC4322_SEGGER_QSPIFI_Test_Board.c
Purpose : Configuration file for serial NOR flash with SFDP connected via SPI.
*/
...
*/
#include "FS.h"
#include "FS_NOR_HW_SPI_LPC4322_SEGGER_QSPIFI_Test_Board.h"
...
**********************************************************************
*/
#define ALLOC_SIZE          0xA000        // Size of memory dedicated to the file system. This value should be fine tuned according for your system.
...
#define BYTES_PER_SECTOR    2048          // Logical sector size
...
void FS_X_AddDevices(void) {
  ...
  FS_NOR_SetPhyType(0, &FS_NOR_PHY_SFDP);
  ...
  FS_NOR_SetEraseVerification(0, 0);
#endif // FS_NOR_VERIFY_ERASE
#if FS_NOR_VERIFY_WRITE
  FS_NOR_SetWriteVerification(0, 0);
#endif // FS_NOR_VERIFY_WRITE
  //
  // Configure the NOR physical layer.
  //
  FS_NOR_SFDP_Allow2bitMode(0, 0);
  FS_NOR_SFDP_Allow4bitMode(0, 0);
  FS_NOR_SFDP_SetHWType(0, &FS_NOR_HW_SPI_LPC4322_SEGGER_QSPIFI_Test_Board);
