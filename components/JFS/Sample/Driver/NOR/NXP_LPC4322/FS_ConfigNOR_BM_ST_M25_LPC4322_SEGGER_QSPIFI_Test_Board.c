...
File    : FS_ConfigNOR_BM_ST_M25_LPC4322_SEGGER_QSPIFI_Test_Board.c
...
#define BYTES_PER_PHY_SECTOR  0x10000       // Required for ISSI IS25CQ032. Set to 0 for auto-detection
#define NUM_PHY_SECTORS       64            // Required for ISSI IS25CQ032. Set to 0 for auto-detection
...
void FS_X_AddDevices(void) {
  ...
  //
  FS_NOR_SPI_SetHWType(0, &FS_NOR_HW_SPI_LPC4322_SEGGER_QSPIFI_Test_Board);
#if NUM_PHY_SECTORS && BYTES_PER_PHY_SECTOR
  FS_NOR_SPI_Configure(0, BYTES_PER_PHY_SECTOR, NUM_PHY_SECTORS);
#endif
}
