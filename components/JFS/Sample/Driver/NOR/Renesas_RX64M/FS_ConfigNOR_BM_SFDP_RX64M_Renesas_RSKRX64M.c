...
File    : FS_ConfigNOR_BM_SFDP_RX64M_Renesas_RSKRX64M.c
...
*/
#include "FS.h"
#include "FS_NOR_HW_SPI_RX64M_Renesas_RSKRX64M.h"
...
void FS_X_AddDevices(void) {
  ...
  //
  FS_NOR_SFDP_SetHWType(0, &FS_NOR_HW_SPI_RX64M_Renesas_RSKRX64M);
