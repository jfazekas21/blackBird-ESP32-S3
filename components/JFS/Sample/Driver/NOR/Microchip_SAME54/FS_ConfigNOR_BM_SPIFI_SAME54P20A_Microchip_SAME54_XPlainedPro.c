...
File    : FS_ConfigNOR_BM_SPIFI_SAME54P20A_Microchip_SAME54_XPlainedPro.c
...
*/
#include "FS.h"
#include "FS_NOR_HW_SPIFI_SAME54P20A_Microchip_SAME54_XPlainedPro.h"
...
*/
  ...
  #define NOR_BASE_ADDR       0x04000000    // Base address of the NOR flash device to be used as storage.
#endif

#ifndef   NOR_START_ADDR
  #define NOR_START_ADDR      0x04000000    // Start address of the first sector be used as storage. If the entire chip is used for file system, it is identical to the base address.
#endif

#ifndef   NOR_SIZE
  #define NOR_SIZE            0x02000000    // Number of bytes to be used for storage
#endif
...
void FS_X_AddDevices(void) {
  ...
  FS_NOR_SPIFI_SetHWType(0, &FS_NOR_HW_SPIFI_SAME54P20A_Microchip_SAME54_XPlainedPro);
