...
File    : FS_ConfigNOR_K60_Freescale_TWR_K60N512.c
...
*/
#include "FS.h"
#include "FS_NOR_PHY_Freescale_K60.h"
...
void FS_X_AddDevices(void) {
  ...
  FS_NOR_BM_SetPhyType(0, &FS_NOR_PHY_Freescale_K60);
  FS_NOR_BM_Configure(0, FLASH_START_ADDR, FLASH_SIZE / 2, FLASH_SIZE / 2);
  //
