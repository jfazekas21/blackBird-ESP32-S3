...
File    : FS_NOR_HW_SPIFI_STM32F469_ST_STM32F469I_DISCO.c
Purpose : Low-level flash driver for STM32F4 QSPI interface.
Literature:
  [1] RM0386 Reference manual STM32F469xx and STM32F479xx advanced ARM-based 32-bit MCUs
    (\\FILESERVER\Techinfo\Company\ST\MCU\STM32\STM32F4\ReferenceManual(RM0386)_STM32F469xx479xx_en.DM00127514.pdf)
  [2] Errata sheet STM32F469xx and STM32F479xx
    (\\FILESERVER\Techinfo_rw\Company\ST\MCU\STM32\STM32F4\ErrataSheet_STM32F469xx_STM32F479xx.pdf)
  [3] Datasheet STM32F469xx
    (\\FILESERVER\Techinfo_rw\Company\ST\MCU\STM32\STM32F4\Datasheet_STM32F469xx.pdf)
  [4] UM1932 User manual Discovery kit with STM32F469NI MCU
    (\\FILESERVER\Techinfo\Company\ST\MCU\STM32\STM32F4\EvalBoard\STM32F469I_DISCO\UM1932_STM32F469NI.pdf)
*/
...
*/
  ...
  #define FS_NOR_HW_PER_CLK_HZ              180000000         // Clock of Quad-SPI unit
#endif

#ifndef   FS_NOR_HW_NOR_CLK_HZ
  #define FS_NOR_HW_NOR_CLK_HZ              45000000          // Frequency of the clock supplied to NOR flash device
#endif
...
**********************************************************************
*/
const FS_NOR_HW_TYPE_SPIFI FS_NOR_HW_SPIFI_STM32F469_ST_STM32F469I_DISCO = {
  _HW_Init,
  _HW_SetCmdMode,
  _HW_SetMemMode,
  _HW_ExecCmd,
