...
File    : FS_ConfigNOR_PHY_Template.c
Purpose : Template configuration file using custom NOR physical layer.
*/
...
#define NOR_START_ADDR      0x80000000     // Start address of the first sector be used as storage. If the entire device is used for file system, this value is identical to the base address.
#define NOR_SIZE            0x200000       // Number of bytes to be used as storage.
...
void FS_X_AddDevices(void) {
  ...
  FS_NOR_SetPhyType(0, &FS_NOR_PHY_Template);
