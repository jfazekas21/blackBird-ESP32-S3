...
File    : FS_ConfigNOR_BM_SFDP_Template.c
Purpose : Template configuration file for SPI NOR flash with SFDP support.
*/
...
*/
#include "FS.h"
#include "FS_NOR_HW_SPI_DualQuad_Template.h"
...
void FS_X_AddDevices(void) {
  ...
  FS_NOR_SFDP_SetHWType(0, &FS_NOR_HW_SPI_DualQuad_Template);
