...
File    : FS_ConfigNOR_BM_SPIFI_Octal_Template.c
Purpose : Template configuration file for memory mapped octal SPI NOR flash.
*/
...
*/
#include "FS.h"
#include "FS_NOR_HW_SPIFI_Octal_Template.h"
...
#define NOR_BASE_ADDR       0x80000000    // Base address of the NOR flash device to be used as storage.
#define NOR_START_ADDR      0x80000000    // Start address of the first sector be used as storage. If the entire chip is used for file system, it is identical to the base address.
...
void FS_X_AddDevices(void) {
  ...
  //
  FS_NOR_SPIFI_AllowOctalMode(0, 1);
  FS_NOR_SPIFI_SetHWType(0, &FS_NOR_HW_SPIFI_Octal_Template);
