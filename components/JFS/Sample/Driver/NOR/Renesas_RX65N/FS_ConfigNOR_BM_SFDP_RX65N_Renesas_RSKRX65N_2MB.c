...
File    : FS_ConfigNOR_BM_SFDP_RX65N_Renesas_RSKRX65N_2MB.c
...
*/
#include "FS.h"
#include "FS_NOR_HW_SPI_RX65N_Renesas_RSKRX65N_2MB.h"
...
#ifndef   NOR_SIZE
  #define NOR_SIZE          0x00400000     // Number of bytes to be used as storage.
#endif
...
void FS_X_AddDevices(void) {
  ...
  //
  FS_NOR_SFDP_SetHWType(0, &FS_NOR_HW_SPI_RX65N_Renesas_RSKRX65N_2MB);
