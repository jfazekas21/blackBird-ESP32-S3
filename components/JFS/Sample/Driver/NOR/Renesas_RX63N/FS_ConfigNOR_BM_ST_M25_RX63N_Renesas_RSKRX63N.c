...
File    : FS_ConfigNOR_BM_ST_M25_RX63N_Renesas_RSKRX63N.c
...
*/
#include "FS.h"
#include "FS_NOR_HW_SPI_RX63N_Renesas_RSKRX63N.h"
...
void FS_X_AddDevices(void) {
  ...
  //
  FS_NOR_SPI_SetHWType(0, &FS_NOR_HW_SPI_RX63N_Renesas_RSKRX63N);
