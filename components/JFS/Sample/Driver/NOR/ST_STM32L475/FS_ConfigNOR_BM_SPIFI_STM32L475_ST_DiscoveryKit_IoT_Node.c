...
File    : FS_ConfigNOR_BM_SPIFI_STM32L475_ST_DiscoveryKit_IoT_Node.c
...
*/
#include "FS.h"
#include "FS_NOR_HW_SPIFI_STM32L475_ST_DiscoveryKit_IoT_Node.h"
...
void FS_X_AddDevices(void) {
  ...
  //
  FS_NOR_SPIFI_SetHWType(0, &FS_NOR_HW_SPIFI_STM32L475_ST_DiscoveryKit_IoT_Node);
