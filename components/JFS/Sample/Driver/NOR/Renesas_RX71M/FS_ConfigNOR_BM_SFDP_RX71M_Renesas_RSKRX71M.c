...
File    : FS_ConfigNOR_BM_SFDP_RX71M_Renesas_RSKRX71M.c
Purpose : Configuration file for FS with NOR driver via SPI.
*/
...
*/
#include "FS.h"
#include "FS_NOR_HW_SPI_RX71M_Renesas_RSKRX71M.h"
...
*/
  ...
  #define NOR_BASE_ADDR       0x00000000     // Base address of the NOR flash device to be used as storage (0 for a serial NOR flash device)
#endif

#ifndef   NOR_START_ADDR
  #define NOR_START_ADDR      0x00000000     // Start address of the first sector be used as storage. If the entire NOR flash device is used for file system, it is identical to the base address.
#endif

#ifndef   NOR_SIZE
  #define NOR_SIZE            0x00400000     // Number of bytes to be used for storage
#endif
...
void FS_X_AddDevices(void) {
  ...
  //
  FS_NOR_SFDP_SetHWType(0, &FS_NOR_HW_SPI_RX71M_Renesas_RSKRX71M);
  FS_NOR_SFDP_SetDeviceList(0, &FS_NOR_SPI_DeviceListMacronix);
  //
