...
File    : FS_ConfigTEMPLATE.c
Purpose : Configuration file for FS with TEMPLATE device driver.
*/
...
void FS_X_AddDevices(void) {
  ...
  //
  // Add the TEMPLATE driver.
  //
  FS_AddDevice(&FS_TEMPLATE_Driver);
  //
