...
File    : FS_NOR_HW_SPI_RX64M_Renesas_RSKRX64M.c
Purpose : NOR SPI hardware layer for Renesas RSKRX64M evaluation board.
Literature:
  [1] RX64M Group User's Manual: Hardware
    (\\fileserver\Techinfo\Company\Renesas\MCU\RX\RX64M\RX64M_HardwareManual_Rev1.10.pdf)
  [2] Renesas Starter Kit+ for RX64M CPU Board Schematics
    (\\fileserver\Techinfo\Company\Renesas\MCU\RX\EvalBoard\RSK_RX64M\RSK+RX64M_Proto_Schema_Rev0.23.pdf)
Additional information:
  The jumpers J11, J12, J13, J14 must be set to position 1-2 in order
  to connect the CPU signals to SPI NOR flash (see [2]).
*/
...
*/
  ...
  #define FS_NOR_HW_SPI_PER_CLOCK_FREQ_KHZ      120000uL  // Clock of SPI peripheral in kHz
#endif
...
**********************************************************************
*/
const FS_NOR_HW_TYPE_SPI FS_NOR_HW_SPI_RX64M_Renesas_RSKRX64M = {
  _HW_Init,
  _HW_EnableCS,
  _HW_DisableCS,
  _HW_Read,
