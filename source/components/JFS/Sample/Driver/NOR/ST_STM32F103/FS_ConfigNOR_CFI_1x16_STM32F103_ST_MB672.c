...
File    : FS_ConfigNOR_CFI_1x16_STM32F103ZET6_ST_MB672.c
...
**********************************************************************
*/
#define ALLOC_SIZE              0x5000         // Size of memory dedicated to the file system. This value should be fine tuned according for your system.
#define FLASH0_BASE_ADDR        0x64000000     // Base address of the NOR flash device to be used as storage
#define FLASH0_START_ADDR       0x64000000     // Start address of the first sector be used as storage. If the entire chip is used for file system, it is identical to the base addr.
