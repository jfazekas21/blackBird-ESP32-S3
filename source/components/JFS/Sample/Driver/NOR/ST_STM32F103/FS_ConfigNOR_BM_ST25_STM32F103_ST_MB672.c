...
Purpose : Configuration file for FS with NOR driver and SPI NOR flash
*/
...
**********************************************************************
*/
#define ALLOC_SIZE          0x1300        // Size of memory dedicated to the file system. This value should be fine tuned according for your system.
...
#define FLASH_SIZE          0x00800000    // Number of bytes to be used for storage
#define BYTES_PER_SECTOR    512           // Size of the logical sector
...
void FS_X_AddDevices(void) {
  ...
  //
  // Configure the size of the logical sector.
  //
