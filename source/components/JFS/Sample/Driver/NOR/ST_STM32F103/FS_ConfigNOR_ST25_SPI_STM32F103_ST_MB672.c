...
File    : FS_ConfigNOR_ST25_SPI_STM32F103_ST_MB672.c
Purpose : Configuration file for FS with NOR driver over SPI
*/
...
*/
#include "FS.h"
#include "FS_NOR_HW_SPI_STM32F103_ST_MB672.h"
...
*/
#ifndef   ALLOC_SIZE
  #define ALLOC_SIZE            0x7300          // Size of memory dedicated to the file system. This value should be fine tuned according for your system.
#endif
  ...
  #define NOR_START_ADDR        0x00000000      // Start address of the first sector be used as storage.
                                                // If the entire chip is used for file system, it is identical to the base addr.
#endif

#ifndef   NOR_SIZE
  #define NOR_SIZE              0x00800000      // Number of bytes to be used as storage.
#endif

#ifndef   LOG_SECTOR_SIZE
  #define LOG_SECTOR_SIZE       2048            // Size of the logical sector in bytes.
#endif
...
void FS_X_AddDevices(void) {
  ...
  FS_NOR_SetSectorSize(0, LOG_SECTOR_SIZE);
  FS_NOR_SPI_SetHWType(0, &FS_NOR_HW_SPI_STM32F103_ST_MB672);
  //
