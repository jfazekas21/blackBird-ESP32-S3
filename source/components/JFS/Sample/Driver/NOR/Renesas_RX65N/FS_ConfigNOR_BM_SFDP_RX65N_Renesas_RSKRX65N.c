...
File    : FS_ConfigNOR_BM_SFDP_RX65N_Renesas_RSKRX65N.c
...
*/
#include "FS.h"
#include "FS_NOR_HW_SPI_RX65N_Renesas_RSKRX65N.h"
...
void FS_X_AddDevices(void) {
  ...
  //
  FS_NOR_SFDP_SetHWType(0, &FS_NOR_HW_SPI_RX65N_Renesas_RSKRX65N);
