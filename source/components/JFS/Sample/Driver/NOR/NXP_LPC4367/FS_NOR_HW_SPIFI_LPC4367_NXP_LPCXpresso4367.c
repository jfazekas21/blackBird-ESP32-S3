...
File    : FS_NOR_HW_SPIFI_LPC4367_NXP_LPCXpresso4367.c
...
*/
  ...
  #define FS_NOR_HW_SPIFI_CLK_HZ          60000000uL    // Frequency of the clock supplied to SPIFI unit.
#endif

#ifndef   FS_NOR_HW_SPIFI_DATA_ADDR
  #define FS_NOR_HW_SPIFI_DATA_ADDR       0x80000000    // This is the start address of the memory region used by the file system
...
**********************************************************************
*/
const FS_NOR_HW_TYPE_SPIFI FS_NOR_HW_SPIFI_LPC4367_NXP_LPCXpresso4367 = {
  _HW_Init,
  _HW_SetCmdMode,
  _HW_SetMemMode,
  _HW_ExecCmd,
