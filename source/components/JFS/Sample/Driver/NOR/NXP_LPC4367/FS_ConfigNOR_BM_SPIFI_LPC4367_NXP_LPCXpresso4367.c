...
File    : FS_ConfigNOR_BM_SPIFI_LPC4367_NXP_LPCXpresso4367.c
...
*/
#include "FS.h"
#include "FS_NOR_HW_SPIFI_LPC4367_NXP_LPCXpresso4367.h"
...
#ifndef   FLASH_SIZE
  #define FLASH_SIZE          0x00100000    // Number of bytes to be used for storage
#endif
...
void FS_X_AddDevices(void) {
  ...
  FS_NOR_SPIFI_SetHWType(0, &FS_NOR_HW_SPIFI_LPC4367_NXP_LPCXpresso4367);
