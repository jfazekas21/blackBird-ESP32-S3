...
File    : FS_NOR_HW_SPIFI_R7FA6M3_Renesas_RA6M3_EK.c
Purpose : Hardware layer for Renesas RA6M4 and quad SPI NOR flash.
Literature  :
  [1] RA6M3 Group User's Manual: Hardware
    (\\fileserver\Techinfo\Company\Renesas\MCU\RA_Series\RA6M3\RA6M3_UserManualHardware_rev1.10.pdf)
  [2] Datasheet RA6M3 Group Renesas Microcontrollers
    (\\fileserver\Techinfo\Company\Renesas\MCU\RA_Series\RA6M3\RA6M3_DataSheet_rev1.10.pdf)
  [3] Evaluation Kit for RA6M3 Microcontroller Group EK-RA6M3 v1 User's Manual
    (\\fileserver\Techinfo\Company\Renesas\MCU\RA_Series\RA6M3\EK_RA6M3_UserManual.pdf)
*/
...
*/
  ...
  #define FS_NOR_HW_PER_CLK_HZ              120000000         // Clock of Quad-SPI peripheral
#endif

#ifndef   FS_NOR_HW_NOR_CLK_HZ
  #define FS_NOR_HW_NOR_CLK_HZ              60000000          // Frequency of the clock supplied to NOR flash device
#endif
...
*/
#define PFS_BASE_ADDR                 0x40040800uL
...
*       Misc. registers
*/
#define MSTP_MSTPCRB                  (*(volatile U32 *)0x40047000)     // Module Stop Control Register B
#define PMISC_PWPR                    (*(volatile U8  *)0x40040D03)
...
**********************************************************************
*/
const FS_NOR_HW_TYPE_SPIFI FS_NOR_HW_SPIFI_R7FA6M3_Renesas_RA6M3_EK = {
  _HW_Init,
  _HW_SetCmdMode,
  _HW_SetMemMode,
  _HW_ExecCmd,
