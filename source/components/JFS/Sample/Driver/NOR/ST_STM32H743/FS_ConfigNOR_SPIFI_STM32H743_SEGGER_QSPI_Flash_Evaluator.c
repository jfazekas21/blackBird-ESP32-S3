...
File        : FS_ConfigNOR_SPIFI_STM32H743_SEGGER_QSPI_Flash_Evaluator.c
...
*/
  ...
  #define ALLOW_2BIT_MODE     1             // Support for exchanging the data via 2 lines.
#endif

#ifndef   ALLOW_4BIT_MODE
  #define ALLOW_4BIT_MODE     1             // Support for exchanging the data via 4 lines.
#endif
