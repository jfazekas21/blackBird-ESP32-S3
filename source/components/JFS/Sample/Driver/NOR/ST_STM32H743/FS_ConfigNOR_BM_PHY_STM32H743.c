...
File    : FS_ConfigNOR_BM_PHY_STM32H743.c
Purpose : Configuration file for emFile with Block Map NOR driver
          and custom physical layer for ST STM32H743.
*/
...
*/
#include "FS.h"
#include "FS_NOR_PHY_STM32H743.h"
...
void FS_X_AddDevices(void) {
  ...
  FS_NOR_BM_SetPhyType(0, &FS_NOR_PHY_STM32H743);
  FS_NOR_BM_Configure(0, FLASH_BASE_ADDR, FLASH_START_ADDR, FLASH_SIZE);
  //
  // Avoid reading from flash before a low-level format operation in order to prevent ECC errors.
  //
