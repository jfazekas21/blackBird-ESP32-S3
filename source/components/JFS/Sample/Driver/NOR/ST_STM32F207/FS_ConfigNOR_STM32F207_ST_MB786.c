...
File    : FS_ConfigNOR_STM32F207_ST_MB786.c
Purpose : FS configuration functions for the NOR driver.
*/
...
*/
#include "FS.h"
#include "FS_NOR_PHY_ST_STM32F207.h"
...
void FS_X_AddDevices(void) {
  ...
  FS_NOR_SetPhyType(0, &FS_NOR_PHY_ST_STM32F207);
