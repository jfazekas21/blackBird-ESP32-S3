...
File    : FS_ConfigNOR_CFI_2x16_LPC4357_Keil_MCB4300.c
Purpose : Configuration file for FS with two 16-bit CFI compliant NOR flash devices.
*/
...
*/
  ...
  #define FLASH_BASE_ADDR     0x1C000000      // Base addr of the NOR flash device to be used as storage
#endif

#ifndef   FLASH_START_ADDR
  #define FLASH_START_ADDR    0x1C000000      // Start addr of the first sector be used as storage. If the entire chip is used for file system, it is identical to the base addr.
#endif
...
void FS_X_AddDevices(void) {
  ...
  FS_NOR_BM_SetPhyType(0, &FS_NOR_PHY_CFI_2x16);
