...
static int _HW_Init(U8 Unit) {
  ...
  GPIOF_AFRL    &= ~(AFR_MASK     << ((NOR_CLK_BIT - 0) << 2));
  GPIOF_AFRL    |=  (0x5uL        << ((NOR_CLK_BIT - 0) << 2));
  ...
  GPIOF_AFRL    &= ~(AFR_MASK     << ((NOR_D0_BIT - 0) << 2));
  GPIOF_AFRL    |=  (0x5uL        << ((NOR_D0_BIT - 0) << 2));
  ...
  GPIOF_AFRL    &= ~(AFR_MASK     << ((NOR_D1_BIT - 0) << 2));
  GPIOF_AFRL    |=  (0x5uL        << ((NOR_D1_BIT - 0) << 2));
  ...
  GPIOF_AFRL    &= ~(AFR_MASK     << ((NOR_D2_BIT - 0) << 2));
  GPIOF_AFRL    |=  (0x5uL        << ((NOR_D2_BIT - 0) << 2));
  ...
  GPIOF_AFRL    &= ~(AFR_MASK     << ((NOR_D3_BIT - 0) << 2));
  GPIOF_AFRL    |=  (0x5uL        << ((NOR_D3_BIT - 0) << 2));
...
**********************************************************************
*/
const FS_NOR_HW_TYPE_SPIFI FS_NOR_HW_SPIFI_STM32U585_ST_B_U585I_IOT02A_Discovery = {
  _HW_Init,
  _HW_Unmap,
#if FS_NOR_HW_USE_MEM_MODE
  _HW_Map,
