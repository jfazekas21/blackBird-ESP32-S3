...
File    : FS_ConfigNOR_CFI_2x16.c
Purpose : Configuration file for two CFI compliant NOR flash devices connected in parallel. 
*/
...
**********************************************************************
*/
#define ALLOC_SIZE        0x10000        // Size of memory dedicated to the file system. This value should be fine tuned according for your system.
#define NOR_BASE_ADDR     0x40000000     // Base address of the NOR flash device to be used as storage
#define NOR_START_ADDR    0x40000000     // Start address of the first sector be used as storage. If the entire chip is used for file system, it is identical to the base address.
#define NOR_SIZE          0x200000       // Number of bytes to be used for storage
