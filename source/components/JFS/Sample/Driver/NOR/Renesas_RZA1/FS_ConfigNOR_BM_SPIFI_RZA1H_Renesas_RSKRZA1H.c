...
File    : FS_ConfigNOR_BM_SPIFI_RZA1H_Renesas_RSKRZA1H.c
...
*/
#include "FS.h"
#include "FS_NOR_HW_SPIFI_RZA1H_Renesas_RSKRZA1H.h"
...
#define FLASH_BASE_ADDR     0x58000000    // Base address of the NOR flash device to be used as storage.
#define FLASH_START_ADDR    0x58000000    // Start address of the first sector be used as storage. If the entire chip is used for file system, it is identical to the base address.
...
void FS_X_AddDevices(void) {
  ...
  FS_NOR_SPIFI_SetHWType(0, &FS_NOR_HW_SPIFI_RZA1H_Renesas_RSKRZA1H);
  FS_NOR_SPIFI_SetDeviceList(0, &FS_NOR_SPI_DeviceListSpansion);
}
