...
File    : FS_ConfigNOR_BM_PHY_STM32F767.c
Purpose : Configuration file for emFile with Block Map NOR driver
          and custom physical layer for ST STM32F767.
*/
...
*/
#include "FS.h"
#include "FS_NOR_PHY_STM32F767.h"
...
void FS_X_AddDevices(void) {
  ...
  FS_NOR_BM_SetPhyType(0, &FS_NOR_PHY_STM32F767);
