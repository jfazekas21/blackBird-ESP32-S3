...
File    : FS_ConfigNOR_BM_SPIFI_LPC54608_NXP_LPCXpresso54608.c
...
*/
#include "FS.h"
#include "FS_NOR_HW_SPIFI_LPC54608_NXP_LPCXpresso54608.h"
...
*/
  ...
  #define FLASH_BASE_ADDR     0x10000000      // Base address of the NOR flash device to be used as storage.
#endif

#ifndef   FLASH_START_ADDR
  #define FLASH_START_ADDR    0x10000000      // Start address of the first sector be used as storage. If the entire chip is used for file system, it is identical to the base address.
#endif
...
void FS_X_AddDevices(void) {
  ...
  FS_NOR_SPIFI_SetHWType(0, &FS_NOR_HW_SPIFI_LPC54608_NXP_LPCXpresso54608);
