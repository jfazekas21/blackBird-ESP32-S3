...
File    : FS_ConfigNOR_BM_SPIFI_STM32MP157_ST_STM32MP15x_EV1.c
...
*/
#include "FS.h"
#include "FS_NOR_HW_SPIFI_STM32MP157_ST_STM32MP15x_EV1.h"
...
**********************************************************************
*/
#define ALLOC_SIZE          0x3000        // Size of memory dedicated to the file system. This value should be fine tuned according for your system.
#define FLASH_BASE_ADDR     0x70000000    // Base address of the NOR flash device to be used as storage.
#define FLASH_START_ADDR    0x71000000    // Start address of the first sector be used as storage. If the entire chip is used for file system, it is identical to the base address.
#define FLASH_SIZE          0x08000000    // Number of bytes to be used for storage
...
void FS_X_AddDevices(void) {
  ...
  //
  FS_NOR_SPIFI_SetHWType(0, &FS_NOR_HW_SPIFI_STM32MP157_ST_STM32MP15x_EV1);
