...
File        : FS_ConfigNOR_BM_SPIFI_STM32F413_ST_32F413HDISCOVERY.c
Purpose     : Configuration file for serial NOR flash connected via QSPI.
*/

#include "FS.h"
#include "FS_NOR_HW_SPIFI_STM32F413_ST_32F413HDISCOVERY.h"
...
void FS_X_AddDevices(void) {
  ...
  //
  FS_NOR_SPIFI_SetHWType(0, &FS_NOR_HW_SPIFI_STM32F413_ST_32F413HDISCOVERY);
