...
File    : FS_ConfigNOR_SFDP_K66_SEGGER_emPower.c
...
*/
#ifndef   ALLOC_SIZE
  #define ALLOC_SIZE          0xC000        // Size defined in bytes
#endif
...
void FS_X_AddDevices(void) {
  ...
  FS_NOR_Configure(0, FLASH_START_ADDR, FLASH_START_ADDR, FLASH_SIZE);
  FS_NOR_SetSectorSize(0, SECTOR_SIZE);
  //
