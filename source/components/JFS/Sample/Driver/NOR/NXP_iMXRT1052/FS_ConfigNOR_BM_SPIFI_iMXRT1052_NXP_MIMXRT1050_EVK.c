...
File    : FS_ConfigNOR_BM_SPIFI_iMXRT1052_NXP_MIMXRT1050_EVK.c
...
*/
#include "FS.h"
#include "FS_NOR_HW_SPIFI_iMXRT1052_NXP_MIMXRT1050_EVK.h"
...
*/
  ...
  #define NOR_START_ADDR      0x60000000    // Start address of the first sector be used as storage. If the entire chip is used for file system, it is identical to the base address.
#endif
...
void FS_X_AddDevices(void) {
  ...
  //
  FS_NOR_SPIFI_SetHWType(0, &FS_NOR_HW_SPIFI_iMXRT1052_NXP_MIMXRT1050_EVK);
  FS_NOR_SPIFI_SetDeviceList(0, &FS_NOR_SPI_DeviceListISSI);
  FS_NOR_SPIFI_Allow2bitMode(0, 0);
