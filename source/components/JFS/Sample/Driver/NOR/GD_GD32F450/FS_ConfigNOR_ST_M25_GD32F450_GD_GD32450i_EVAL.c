...
File    : FS_ConfigNOR_ST_M25_GD32F450_GD_GD32450i_EVAL.c
Purpose : Configuration file for serial NOR flash connected via SPI.
*/

#include "FS.h"
#include "FS_NOR_HW_SPI_GD32F450_GD_GD32450i_EVAL.h"
...
void FS_X_AddDevices(void) {
  ...
  //
  FS_NOR_SPI_SetHWType(0, &FS_NOR_HW_SPI_GD32F450_GD_GD32450i_EVAL);
}
