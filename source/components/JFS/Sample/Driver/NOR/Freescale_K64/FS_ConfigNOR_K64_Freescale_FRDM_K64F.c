...
File    : FS_ConfigNOR_K64_Freescale_FRDM_K64F.c
...
*/
#include "FS.h"
#include "FS_NOR_PHY_Freescale_K64.h"
...
void FS_X_AddDevices(void) {
  ...
  FS_NOR_SetPhyType(0, &FS_NOR_PHY_Freescale_K64);
  FS_NOR_Configure(0, FLASH_START_ADDR, FLASH_SIZE / 2, FLASH_SIZE / 2);
  //
