...
*/
  ...
  #define FS_OPTIMIZATION_TYPE                  FS_OPTIMIZATION_TYPE_MAX_SPEED // FS_OPTIMIZATION_TYPE_BALANCED     // Optimization goal of the file system.
#endif
...
*/
  ...
  #define FS_SUPPORT_JOURNAL                      1     // Enables/disables the support for journaling.
#endif
