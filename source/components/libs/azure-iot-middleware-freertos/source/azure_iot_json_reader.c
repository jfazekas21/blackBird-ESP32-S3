                                                  ...
                                                  bool * pxValue )
{
    ...
    {
    	printf("Enter in else statement");
                                                    ...
                                                    uint32_t * pusBytesCopied )
{
    ...
    {
    	printf("Token:%s\n",(char*)pxReader->_internal.xCoreReader.token.slice._internal.ptr);
    	printf("Token Size:%ld\n",(int32_t)pxReader->_internal.xCoreReader.token.slice._internal.size);
    ...
    printf("eAzureIoTErrorInvalidArgument:%d,eAzureIoTSuccess:%d\n",eAzureIoTErrorInvalidArgument,eAzureIoTSuccess);
    printf("xResult:%d\n",xResult);
    return xResult;
}
