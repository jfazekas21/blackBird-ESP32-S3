...
//#include "../../../bootloader_components/driver/gpio/include/driver/gpio.h"
...
void __attribute__((noreturn)) call_start_cpu0(void)
{
    ...
    boot_index = select_partition_number(&bs);
...
//			return INVALID_INDEX;
    	...
    	ESP_LOGI(TAG, "boot condition of the test firmware is not detected.");
#endif
...
//    gpio_set_direction(GPIO_NUM_5, GPIO_MODE_INPUT);
    ESP_LOGI(TAG, "boot_index = %d", boot_index);
